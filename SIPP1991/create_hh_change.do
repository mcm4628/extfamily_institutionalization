...
use "$SIPP91keep/comp_change.dta", clear
...
********************************************************************************
* Function Propagate shhadid_members forward into prev_SHHADID for missing waves.
********************************************************************************
...
save "$SIPP91keep/hh_change.dta", $replace
