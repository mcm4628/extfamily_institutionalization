...
keep `i_vars' `j_vars' EEDUCATE TMOVEUS TBRSTATE TAGE
sort `i_vars' `j_vars' EEDUCATE TMOVEUS TBRSTATE TAGE
...
rename TMOVEUS ptmoveus /* ptmoveus for "parent move to us" */
rename TBRSTATE ptbrstate /*ptbrstate for "parent birthplace"*/


save "$tempdir/person_pdemo_am", $replace

* create a dataset of household reference persons.
do "$childhh_base_code/SIPP2001/allmonths/make_aux_refperson_am"
