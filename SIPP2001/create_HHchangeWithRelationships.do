...
merge 1:m SSUID EPPPNUM SWAVE using "$tempdir/changer_rels", keepusing(relationship ///
...
merge 1:1 SSUID EPPPNUM SWAVE using "$SIPP01keep/hh_change.dta"
...
save "$SIPP01keep/HHchangeWithRelationships.dta", $replace
