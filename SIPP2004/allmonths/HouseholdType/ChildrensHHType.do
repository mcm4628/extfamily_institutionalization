...
use "$SIPP04keep/HHComp_asis_am", clear
...
putexcel set "$results/compare04.xlsx", sheet(HHmembers) replace
...
merge 1:1 SSUID EPPPNUM panelmonth using "$SIPP04keep/demo_long_interviews_am.dta", keepusing(WPFINWGT my_racealt adj_age my_sex biomom_ed_first par_ed_first ref_person_educ mom_measure)
