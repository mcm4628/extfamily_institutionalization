...
merge 1:1 SSUID EPPPNUM panelmonth using "$SIPP04keep/demo_long_interviews_am.dta", keepusing(adj_age my_sex)
...
merge m:1 SSUID EPPPNUM panelmonth using "$SIPP04keep/demo_long_interviews_am.dta"
...
save "$SIPP04keep/HHComp_asis_am.dta", $replace
