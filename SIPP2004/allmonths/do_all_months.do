...
do "$childhh_base_code/do_and_log" "$sipp2004_code" "$sipp2004_logs" make_auxiliary_datasets_am 

** Generates a wide dataset by person (includes static demographic variables). 
do "$childhh_base_code/do_and_log" "$sipp2004_code" "$sipp2004_logs" convert_to_wide_am 
...
do "$childhh_base_code/do_and_log" "$sipp2004_code" "$sipp2004_logs" normalize_ages_am 

** Computes biderectional base relationships (mom, dad, child, spouse) 
do "$childhh_base_code/do_and_log" "$sipp2004_code" "$sipp2004_logs" compute_base_relationships_am 

** Identifies additional relationships transitively
do "$childhh_base_code/do_and_log" "$sipp2004_code" "$sipp2004_logs" compute_secondary_relationships_am 
...
do "$childhh_base_code/do_and_log" "$sipp2004_code" "$sipp2004_logs" create_comp_change_am 

** Creates addr_change and hh_change. Converts data file to long. Core file: hh_change.dta
do "$childhh_base_code/do_and_log" "$sipp2004_code" "$sipp2004_logs" create_hh_change_am 
...
do "$childhh_base_code/do_and_log" "$sipp2004_code" "$sipp2004_logs" create_changer_rels_am 

** Merges relationship of changers to ego back to comp_change
do "$childhh_base_code/do_and_log" "$sipp2004_code" "$sipp2004_logs" create_HHchangeWithRelationships_am
