use "$SIPP2004tm/sippp04putm2.dta", clear
...
save "$SIPP04keep/relationship_matrix", $replace

use "$tempdir/relationship_pairs_bymonth"

keep if panelmonth==5

merge 1:1 SSUID relto relfrom using "$SIPP04keep/relationship_matrix"


putexcel set "$results/compare_relationships04.xlsx", sheet(checkrels) modify
