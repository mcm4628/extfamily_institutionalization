...
merge 1:1 SSUID EPPPNUM SWAVE using "$SIPP04keep/demo_long_interviews.dta", keepusing(adj_age my_sex)
...
merge m:1 SSUID EPPPNUM SWAVE using "$SIPP04keep/demo_long_interviews.dta"
...
save "$SIPP04keep/HHComp_asis.dta", $replace
