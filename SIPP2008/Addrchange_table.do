...
forvalues r=1/5 {
  local rw=(`r'-1)*18+4
  tab adj_age addr_change [aweight=WPFINWGT] if first_raceth==`r', matcell(agerace`r')
...
forvalues e=1/4 {
  local rw=(`e'-1)*18+4
  tab adj_age addr_change [aweight=WPFINWGT] if momfirstced==`e', matcell(ageeduc`e')
