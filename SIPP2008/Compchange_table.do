...
putexcel A1="Table A3. Composition Change by Race-Ethnicity and Householder Education"
...
forvalues r=1/5 {
  local rw=(`r'-1)*17+4
  tab adj_age comp_change [aweight=WPFINWGT] if raceth==`r', matcell(agerace`r')
...
forvalues e=1/4 {
  local rw=(`e'-1)*17+4
  tab adj_age comp_change [aweight=WPFINWGT] if hheduc==`e', matcell(ageeduc`e')
