...
use "$SIPP08keep/demo_long_all_am.dta", clear
...
save "$tempdir/annualized_demo08.dta", replace

use "$SIPP08keep/hh_change_am.dta", clear
...
merge 1:1 SSUID EPPPNUM panelmonth using "$tempdir/annualized_demo08.dta"
...
save "$SIPP08keep/annualized_change08.dta", replace
