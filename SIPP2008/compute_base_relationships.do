...
local lnum = 1
foreach r in BIOCHILD BIOMOM BIODAD STEPCHILD STEPMOM STEPDAD ADOPTCHILD ADOPTMOM ADOPTDAD MOM DAD SPOUSE GRANDCHILD GRANDPARENT SIBLING OTHER_REL PARTNER CHILDOFPARTNER F_CHILD CHILD F_PARENT NOREL PARENT AUNTUNCLE AUNTUNCLE_OR_PARENT GREATGRANDCHILD NEPHEWNIECE COUSIN SIBLING_OR_COUSIN CONFUSED DONTKNOW {
