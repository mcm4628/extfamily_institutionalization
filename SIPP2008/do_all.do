...
//===== Dataset: SIPP2008
//===== Purpose: Executes all do-files for the project.
//===============================================================================//
...
//== 
//== Note: This program requires the mdesc package. If you do not have this, type ssc install mdesc before running.
...
**
** Logic: We can't use do_and_log, because we need the macros for temp dir and log dir to pass to it.
***************************************************************************
...
** This do-file contains tabulations of household characteristics.
...
//============================================================//
//===== Attention! The following do-files are starred
//============================================================//
...
** This do-file computes composition change and address change.
...
** This do-file creates a pairwise dataset with every pair of people living together.
...
** This do-file computes the number of relations. 
do "$childhh_base_code/do_and_log" "$sipp2008_code" "$sipp2008_logs" count_rels 

** This do-file generates partner type for young women(17-25).
