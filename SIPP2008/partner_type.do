...
//===== Dataset: SIPP2008                                       
//===== Purpose: Computes partner type for young women.  
//===== Logic: It uses the directly derived relationships (TC0), and the first pass of secondary relationships (TC1). 
//=======================================================================================//
...
forvalues tc = 0/1 {
	...
	* Compute partner type, giving precedence to spouse, then partner.  
	* If we don't have any relationship data for the person at all we mark partner type as missing.
#delim ;
...
#delim cr
    ...
    * Take the max partner type, so this gives precedenct to spouse, then partner.
...
#delim cr
    ...
    * Save the TC`tc' young women's partnership data.
