...
use "$SIPP14keep/faminst_analysis.dta", clear

tab comp_changey, m 
tab hhsplity, m 

keep if !missing(comp_changey)

putexcel set "$results/InstitutionalizedExtension", sheet(descriptives14) modify
...
putexcel A6=" any aunt/uncle/nephew/niece"
...
local baseline "i.year i.adj_age i.par_ed_first i.parentcomp mom_age mom_age2 hhsize"
