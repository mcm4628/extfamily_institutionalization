...
reshape long SHHADID adj_age arrivers leavers stayers comp_change comp_change_reason, i(SSUID PNUM) j(panelmonth)
...
foreach changer in leaver arriver stayer {
    ...
    * Compute max number of leavers/arrivers.
    ...
    keep SSUID PNUM SHHADID panelmonth adj_age comp_change_reason n_`changer's `changer'* 
...
* in the relationship matrix available in Month 2 (see relationship_matrix.do) 
