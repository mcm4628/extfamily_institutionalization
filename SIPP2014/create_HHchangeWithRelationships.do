...
use "$SIPP14keep/hh_change.dta"

keep SSUID PNUM SWAVE comp_change hh_change addr_change 
...
merge 1:m SSUID PNUM SWAVE using "$tempdir/changer_rels", keepusing(relationship ///
...
save "$SIPP14keep/HHchangeWithRelationships.dta", $replace
