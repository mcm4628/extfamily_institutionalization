...
keep SSUID PNUM SHHADID* adj_age* comp_change* addr_change* comp_change_reason* original agewave1

reshape long SHHADID adj_age comp_change addr_change comp_change_reason, i(SSUID PNUM) j(SWAVE)

merge 1:1 SSUID PNUM SWAVE using "$tempdir/demo_long_all.dta"
...
save "$SIPP14keep/hh_change.dta", $replace
